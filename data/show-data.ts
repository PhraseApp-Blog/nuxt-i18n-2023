export const showData = [
  ...
  },
  {
    ...
    img: "/img/shows/bad-batch.png",
    premieredAt: "2021-05-04",
    episodeCount: 32,
    description:
  ...
  },
  {
    ...
    img: "/img/shows/tales-of-jedi.png",
    premieredAt: "2022-10-26",
    episodeCount: 6,
    description:
      "Tales of the Jedi, also known as Star Wars: Tales of the Jedi, is an American animated anthology series created by Dave Filoni. It is part of the Star Wars franchise, exploring different Jedi characters from the prequel trilogy era. The series was produced by Lucasfilm Animation, with Charles Murray as head writer and Filoni as supervising director, for the streaming service Disney+.",
  },
  {
    id: 5,
    name: "Obi-Wan Kenobi",
    img: "/img/shows/obi-wan-kenobi.png",
    premieredAt: "2022-05-27",
    episodeCount: 6,
    description:
  ...
  },
  {
    id: 5,
    name: "Light & Magic",
    img: "/img/shows/light-magic.png",
    premieredAt: "2022-07-27",
    episodeCount: 6,
    description:
